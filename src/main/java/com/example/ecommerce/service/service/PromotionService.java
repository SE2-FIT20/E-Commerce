...
public interface PromotionService {
    ...
    ResponseEntity<Response> createPromotion(Promotion promotion);
    ResponseEntity<Response> deletePromotion(Long promotionId);
    ResponseEntity<Response> updatePromotion(Long promotionId, UpdatePromotionRequest updatePromotionRequest);
